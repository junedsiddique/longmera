...
of longitudinal data. In these models, users are typically interested in calculating group means at different time points, differences in group means at the same time point
differences of means between two time points (change), and differences in change between groups. 
Currently, the longmera package can handle objects from the following types of longitudinal models:
